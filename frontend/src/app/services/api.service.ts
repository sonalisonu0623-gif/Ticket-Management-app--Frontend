...
export class ApiService {
  ...
  getProjects(status?: string): Observable<Project[]> {
    ...
    return this.http.get<ApiResponse<Project[]>>(`${BASE}/projects`, { params: p })
      .pipe(map(r => r.data ?? []));
  }

  getProjectById(id: number): Observable<Project> {
    return this.http.get<ApiResponse<Project>>(`${BASE}/projects/${id}`)
      .pipe(map(r => r.data));
  }

  createProject(p: Project): Observable<Project> {
    return this.http.post<ApiResponse<Project>>(`${BASE}/projects`, p)
      .pipe(map(r => r.data));
  }

  updateProject(id: number, p: Project): Observable<Project> {
    return this.http.put<ApiResponse<Project>>(`${BASE}/projects/${id}`, p)
      .pipe(map(r => r.data));
  }

  deleteProject(id: number): Observable<void> {
    return this.http.delete<ApiResponse<void>>(`${BASE}/projects/${id}`)
      .pipe(map(() => void 0));
  }

  activateProject(id: number): Observable<Project> {
    return this.http.patch<ApiResponse<Project>>(`${BASE}/projects/${id}/activate`, {})
      .pipe(map(r => r.data));
  }

  deactivateProject(id: number): Observable<Project> {
    return this.http.patch<ApiResponse<Project>>(`${BASE}/projects/${id}/deactivate`, {})
      .pipe(map(r => r.data));
  }
  ...
  getEmployees(projectId?: number, supportLevel?: string): Observable<Employee[]> {
    ...
    return this.http.get<ApiResponse<Employee[]>>(`${BASE}/employees`, { params: p })
      .pipe(map(r => r.data ?? []));
  }

  getEmployeeById(id: number): Observable<Employee> {
    return this.http.get<ApiResponse<Employee>>(`${BASE}/employees/${id}`)
      .pipe(map(r => r.data));
  }

  createEmployee(e: Employee): Observable<Employee> {
    return this.http.post<ApiResponse<Employee>>(`${BASE}/employees`, e)
      .pipe(map(r => r.data));
  }

  updateEmployee(id: number, e: Employee): Observable<Employee> {
    return this.http.put<ApiResponse<Employee>>(`${BASE}/employees/${id}`, e)
      .pipe(map(r => r.data));
  }

  deleteEmployee(id: number): Observable<void> {
    return this.http.delete<ApiResponse<void>>(`${BASE}/employees/${id}`)
      .pipe(map(() => void 0));
  }
  ...
  getTicketById(id: number): Observable<Ticket> {
    return this.http.get<ApiResponse<Ticket>>(`${BASE}/tickets/${id}`)
      .pipe(map(r => r.data));
  }

  createTicket(t: Ticket): Observable<Ticket> {
    return this.http.post<ApiResponse<Ticket>>(`${BASE}/tickets`, t)
      .pipe(map(r => r.data));
  }

  updateTicket(id: number, t: Ticket): Observable<Ticket> {
    return this.http.put<ApiResponse<Ticket>>(`${BASE}/tickets/${id}`, t)
      .pipe(map(r => r.data));
  }

  deleteTicket(id: number): Observable<void> {
    return this.http.delete<ApiResponse<void>>(`${BASE}/tickets/${id}`)
      .pipe(map(() => void 0));
  }
  ...
  getDashboard(projectId?: number): Observable<DashboardDTO> {
    ...
    return this.http.get<ApiResponse<DashboardDTO>>(`${BASE}/dashboard`, { params: p })
      .pipe(map(r => r.data));
  }

  // ── Shifts ────────────────────────────────────────────────
  getShifts(): Observable<Shift[]> {
    return this.http.get<ApiResponse<Shift[]>>(`${BASE}/shifts`)
      .pipe(map(r => r.data ?? []));
  }

  createShift(s: Shift): Observable<Shift> {
    return this.http.post<ApiResponse<Shift>>(`${BASE}/shifts`, s)
      .pipe(map(r => r.data));
  }

  updateShift(id: number, s: Shift): Observable<Shift> {
    return this.http.put<ApiResponse<Shift>>(`${BASE}/shifts/${id}`, s)
      .pipe(map(r => r.data));
  }

  deleteShift(id: number): Observable<void> {
    return this.http.delete<ApiResponse<void>>(`${BASE}/shifts/${id}`)
      .pipe(map(() => void 0));
  }
  ...
  getSlaConfigs(projectId?: number): Observable<SlaConfig[]> {
    const p = projectId ? new HttpParams().set('projectId', projectId) : undefined;
    return this.http.get<ApiResponse<SlaConfig[]>>(`${BASE}/sla-configs`, { params: p })
      .pipe(map(r => r.data ?? []));
  }

  createSlaConfig(s: SlaConfig): Observable<SlaConfig> {
    return this.http.post<ApiResponse<SlaConfig>>(`${BASE}/sla-configs`, s)
      .pipe(map(r => r.data));
  }

  updateSlaConfig(id: number, s: SlaConfig): Observable<SlaConfig> {
    return this.http.put<ApiResponse<SlaConfig>>(`${BASE}/sla-configs/${id}`, s)
      .pipe(map(r => r.data));
  }

  deleteSlaConfig(id: number): Observable<void> {
    return this.http.delete<ApiResponse<void>>(`${BASE}/sla-configs/${id}`)
      .pipe(map(() => void 0));
  }
